    ...
    useEffect(() => {
        async function checkWithWorker() {
            ...
            if (window.location.search === "") {
                changedResult = (
                    <div>
                        Sorry, you must <Link to="/onboard">sign up here</Link>{" "}
                ...
                changedResult = (
                    <div>
                        Sorry! Signup failed with code $
                        {searchParams.get("error")} for reason $
                        {searchParams.get("error_description")}. If you believe
                        this is a mistake,{" "}
                ...
                if (workerResponse.status === 200) {
                    changedResult = (
                        <div>
                            Thanks for signing up with Hedwig! Your vendor page
                    ...
                    changedResult = (
                        <div>
                            Please don't attempt to use anything other than
                            POST. Go back to{" "}
